...
import ec.diners.com.application.commands.user.login.AuthenticateUserCommand;
import ec.diners.com.application.commands.user.login.AuthenticateUserCommandResponse;
